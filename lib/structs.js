...
const _symbolPriceQuery = fs.readFileSync(path.resolve(__dirname, '../constants/CustomPriceQuery.gql'), 'utf8')
...
class AssetSearchQuery extends Query {
    ...
    // collections: 'hashmasks', 'waifusion', 'bastard-gan-punks-v2', 'wrapped-mooncatsrescue'
...
class SymbolPriceQuery extends Query {
    ...
    init (symbol) {
        super.init(_symbolPriceQuery)
        this.variables.symbol = symbol
    }
}
